...
{
    /// <inheritdoc />
    public partial class Step12_AuthorizationAndScopes : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ScopeDefinitions", x => x.Name);
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_OAuthClients_ClientName",
                table: "OAuthClients",
                column: "ClientName");

            migrationBuilder.CreateIndex(
                name: "IX_OAuthClients_ClientType",
                table: "OAuthClients",
                column: "ClientType");

            migrationBuilder.CreateIndex(
                name: "IX_OAuthClients_CreatedBy",
                table: "OAuthClients",
                column: "CreatedBy");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ScopeDefinitions_Category",
                table: "ScopeDefinitions",
                column: "Category");

            migrationBuilder.CreateIndex(
                name: "IX_ScopeDefinitions_IsActive",
                table: "ScopeDefinitions",
                column: "IsActive");

            migrationBuilder.CreateIndex(
                name: "IX_ScopeDefinitions_IsDefault",
                table: "ScopeDefinitions",
                column: "IsDefault");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UserConsents_IsRevoked",
                table: "UserConsents",
                column: "IsRevoked");
